...
public class Trial {
	...
	public override string ToString() {
		return "{collision:" + collision + ", robotSwerve:" + robotSwerve + ", robotPlayerDistance:" + robotPlayerDistance + ", robotStartDistance:" + robotStartDistance + ", playerTrajectory:" + playerTrajectory + ", robotTrajectory:" + robotTrajectory + ", trialNum:" + trialNum + ", robotType:" + robotType + ", trialType:" + trialType + "}";
	}
}
