...
#pragma warning disable
	...
	[SerializeField]
	private Material pepperBlue;
	[SerializeField]
	private Material pepperRed;
	[SerializeField]
	private Material pepperPurple;
	[SerializeField]
	private Material pepperYellow;
	[SerializeField]
	private Material pepperPink;
	[SerializeField]
	private Material pepperGreen;
	[SerializeField]
	private Material pepperBrown;
	[SerializeField]
	private Material pepperOrange;
	[SerializeField]
	private Material pepperBlack;
	[SerializeField]
...
#pragma warning restore
	...
	void Start() {
		...
		pepperMaterials.Add(RobotColor.BLUE, pepperBlue);
		pepperMaterials.Add(RobotColor.RED, pepperRed);
		pepperMaterials.Add(RobotColor.PURPLE, pepperPurple);
		pepperMaterials.Add(RobotColor.YELLOW, pepperYellow);
		pepperMaterials.Add(RobotColor.PINK, pepperPink);
		pepperMaterials.Add(RobotColor.GREEN, pepperGreen);
		pepperMaterials.Add(RobotColor.BROWN, pepperBrown);
		pepperMaterials.Add(RobotColor.ORANGE, pepperOrange);
		pepperMaterials.Add(RobotColor.BLACK, pepperBlack);
