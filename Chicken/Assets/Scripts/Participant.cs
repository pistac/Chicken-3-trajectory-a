...
public class Participant {
	...
	public Participant(bool seenRobotsBefore, int age, string country, string gamesExperience, string gender, string levelOfEducation, string robotExperience) {
		...
		this.familiarityChicken = gamesExperience;
		this.gender = gender;
	...
	public override string ToString() {
		return "{seenRobotsBefore:" + seenRobotsBefore + ", age:" + age + ", country:" + country + ", familiarityChicken:" + familiarityChicken + ", gender:" + gender + ", levelOfEducation:" + levelOfEducation + ", robotExperience:" + robotExperience + "}";
	}
}
